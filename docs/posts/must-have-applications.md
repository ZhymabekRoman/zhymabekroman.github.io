...
4. Chromium - (pure) open-source web browser.
5. Obsidian - second brain.
...
2. vim - best IDE in the world! My config file - [GitHub repo](https://github.com/ZhymabekRoman/dotconfig). As an alternative I've tried to using NeoVIM, but for me it's not convenient.
...
8. Telegram for primary account and my custom Forkgram version for other accounts.
